About jupyterlab-fileopen-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-fileopen-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12893&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-fileopen-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-fileopen` can be installed with `conda`:
...
```
mamba install jupyterlab-fileopen
```

It is possible to list all of the versions of `jupyterlab-fileopen` available on your platform with `conda`:
...
```
mamba search jupyterlab-fileopen --channel conda-forge
```
...
mamba repoquery search jupyterlab-fileopen --channel conda-forge

# List packages depending on `jupyterlab-fileopen`:
mamba repoquery whoneeds jupyterlab-fileopen --channel conda-forge

# List dependencies of `jupyterlab-fileopen`:
mamba repoquery depends jupyterlab-fileopen --channel conda-forge
```
